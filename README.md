...
#### Dataset
We train and evaluate on the [[multi-view Middlebury dataset](https://vision.middlebury.edu/mview/data/)] as well synthetic multi-view images generated on Blender. The script for Blender dataset generation is located 
#### Deterministic Visual Hull

We implement a voxel-based deterministic.
